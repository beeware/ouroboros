...
import ouroboros.cmath as cmath
from ouroboros.cmath import phase, polar, rect, pi
...
class CMathTests(unittest.TestCase):
    ...
    def test_constants(self):
        ...
        tau_expected = 6.28318530717958647692
        ...
        self.assertAlmostEqual(cmath.tau, tau_expected, places=9,
            msg="cmath.tau is {}; should be {}".format(cmath.tau, tau_expected))
...
class IsCloseTests(unittest.TestCase):
    isclose = staticmethod(cmath.isclose)

    def assertIsClose(self, a, b, **kwargs):
        self.assertTrue(self.isclose(a, b, **kwargs),
                        msg="%s and %s should be close!" % (a, b))

    def assertIsNotClose(self, a, b, **kwargs):
        self.assertFalse(self.isclose(a, b, **kwargs),
                         msg="%s and %s should not be close!" % (a, b))

    def assertAllClose(self, examples, **kwargs):
        for a, b in examples:
            self.assertIsClose(a, b, **kwargs)

    def assertAllNotClose(self, examples, *args, **kwargs):
        for a, b in examples:
            self.assertIsNotClose(a, b, **kwargs)
